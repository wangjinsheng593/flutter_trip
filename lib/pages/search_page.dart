          ...
          children: <Widget>[
            Container(
              ...
              child: Image(
                height: 26,
                width: 26,
                image: AssetImage(_typeImage(item.type)),//加载本地图片需要借助AssetImage
              ),
            ),
            Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: _suTitle(item)//Text('${item.price??''} ${item.type??''}'),
                )
              ],
            )
          ],
